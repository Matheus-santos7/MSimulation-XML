...
import { montarItemFiscal } from "../tax/tax-calculation-service.js";
import { resolveTaxRule, type CustomerType } from "../tax/tax-rule-service.js";
import { persistNfeXmlFromEmission } from "../shared/nfe-xml-service.js";
import { estornarConsumosRemessa } from "../remessa/remessa-fifo.js";
import {
  prepararRemessaSimbolicaFiscal,
  RemessaSimbolicaFiscalError,
} from "../remessa/remessa-simbolica-fiscal.js";
