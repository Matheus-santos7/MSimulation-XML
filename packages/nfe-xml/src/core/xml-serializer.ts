/**
 * Serializador objeto → XML para o pacote `nfe-xml`.
 *
 ...
 * @example
 * ```ts
 * const xml = new XmlSerializer().serializeDocument({
 *   declaration: { version: "1.0", encoding: "UTF-8" },
 *   root: {
 *     nfeProc: {
 *       "@xmlns": "http://www.portalfiscal.inf.br/nfe",
 *       "@versao": "4.00",
 *       NFe: { infNFe: { "@Id": "NFe...", ide: { cUF: 41 } } },
 *     },
 *   },
 * });
 * ```
 ...
 * Mantém API compatível com consumidores que esperam função pura.
 */
