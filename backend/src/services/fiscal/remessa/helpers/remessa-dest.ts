 ...
 *
 * - `REMESSA_NAT_OP` / `REMESSA_INF_CPL` — textos fiscais do cabeçalho e infAdic.
 * - `resolveRemessaCfop` — CFOP por UF (5949 intra / 6949 inter); ver docs/remessa-fisica.md.
 * - `REMESSA_ML_*` — fallback legado quando não há unidade na planilha de CDs.
 */
/** Destinatário padrão ML — depósito temporário (modelo interestadual legado). */
