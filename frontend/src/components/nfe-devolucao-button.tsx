...
export function NfeDevolucaoMenuItem({
  jaDevolvida,
  parcial,
  onSelect,
}: {
...
/**
 * Dialog de devolução — deve viver FORA de `DropdownMenuContent`.
 * Se ficar dentro, fechar o menu ⋮ desmonta o modal no mesmo clique.
 */
export function NfeDevolucaoDialog({ open, onOpenChange, chave, label }: DialogProps) {
        ...
        <DialogHeader className="min-w-0 shrink-0 space-y-1.5 text-left">
          ...
          <DialogDescription asChild>
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                O saldo devolvido retorna às <strong className="text-foreground">remessas</strong> da
                cadeia (estorno FIFO) e a reposição ao CD sai como remessa simbólica dos itens
                devolvidos.
              </p>
            </div>
          </DialogDescription>
